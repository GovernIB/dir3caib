    ...
    create table DIR_UNIDAD (
        ...
        CODCOMUNIDAD int8,
        CODEDPPRINCIPAL varchar(20),
        CODLOCALIDADID int8,
        CODPAIS int8,
        CODTIPOENTPUBLICA varchar(2),
        CODTIPOUNIDAD varchar(3),
        CODUNIDADRAIZ varchar(20),
        CODUNIDADSUPERIOR varchar(20),
        ESTADO varchar(2),
        NIVELADMINISTRACION int8,
        PODER int8,
        TIPOVIA int8,
