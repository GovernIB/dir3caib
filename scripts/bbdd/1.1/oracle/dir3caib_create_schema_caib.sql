    ...
    create table DIR_NIFCIFUO (
        CODNIFCIF number(19,0) not null,
 ...
 -- INICI PK's
    ...
    alter table DIR_NIFCIFUO add constraint DIR_NIFCIFUO_pk primary key (CODNIFCIF);
 ...
 -- INICI GRANTS
    ...
    grant select on DIR_UNI_SEQ to www_dir3caib;
 -- FINAL GRANTS
