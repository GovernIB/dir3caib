...
public class Dir3RestBean implements Dir3RestLocal {
	...
	@Override
	@SuppressWarnings(value = "unchecked")
	public List<UnidadExportar> exportarUnidades(Long comunidadAutonoma, Long nivelAdministracion) throws Exception {

		StringBuilder query = new StringBuilder(
				"Select distinct(unidad.codigo), unidad.denominacion, unidad.estado.codigoEstadoEntidad, "
				+ "unidad.codUnidadRaiz.codigo, unidad.codUnidadRaiz.denominacion, unidad.codUnidadSuperior.codigo, "
						+ " unidad.codUnidadSuperior.denominacion, unidad.codLocalidad.descripcionLocalidad, unidad.esEdp, "
						+ "unidad.nivelJerarquico, unidad.nifcif, unidad.nivelAdministracion.descripcionNivelAdministracion, "
						+ "unidad.codTipoUnidad.descripcionTipoUnidadOrganica, "
						+ " unidad.tipoVia.descripcionTipoVia, unidad.nombreVia, unidad.numVia, unidad.complemento, unidad.codPostal, "
						+ "unidad.codAmbitoTerritorial.descripcionAmbito, unidad.codAmbPais.descripcionPais, unidad.codAmbComunidad.descripcionComunidad, "
						+ " unidad.codAmbProvincia.descripcionProvincia, unidad.codAmbIsla.descripcionIsla, unidad.denomLenguaCooficial, "
						+ "unidad.codUnidadRaiz.denomLenguaCooficial, unidad.codUnidadSuperior.denomLenguaCooficial, "
						+ " unidad.codigoDir3, unidad.codUnidadRaiz.codigoDir3, unidad.codUnidadSuperior.codigoDir3, unidad.version, "
						+ "unidad.nivelAdministracion.codigoNivelAdministracion, unidad.codAmbitoTerritorial.codigoAmbito, unidad.codAmbPais.codigoPais, "
						+ " unidad.codAmbProvincia.codigoProvincia, unidad.tipoVia.codigoTipoVia, unidad.estado.descripcionEstadoEntidad, "
						+ "unidad.codLocalidad.descripcionLocalidad, unidad.codAmbComunidad.codigoComunidad"
						...
						+ " where unidad.estado.codigoEstadoEntidad = :estat ");

		if (comunidadAutonoma != null && comunidadAutonoma > 0)
			query.append("and unidad.codAmbComunidad.codigoComunidad = :comunidadAutonoma ");

		if (nivelAdministracion != null && nivelAdministracion > 0)
			query.append("and unidad.nivelAdministracion.codigoNivelAdministracion = :nivelAdministracion ");
		else if( nivelAdministracion == null) 
			query.append("and unidad.nivelAdministracion.codigoNivelAdministracion is NULL ");
		
		
		Query q = em.createQuery(query.toString());
		q.setParameter("estat", Dir3caibConstantes.ESTADO_ENTIDAD_VIGENTE);

		if (nivelAdministracion != null && nivelAdministracion > 0)
			q.setParameter("nivelAdministracion", nivelAdministracion);

		if (comunidadAutonoma != null && comunidadAutonoma > 0)
			q.setParameter("comunidadAutonoma", comunidadAutonoma);

		List<UnidadExportar> resultados = transformarAUnidadExportar(q.getResultList());

		StringBuilder queryContactos = new StringBuilder(
				"Select contacto.valorContacto, contacto.tipoContacto.codigoTipoContacto "
				+ "from ContactoUnidadOrganica as contacto left outer join contacto.tipoContacto as tipoContacto "
				+ "where contacto.estado.codigoEstadoEntidad = :estat1 "
				+ "and contacto.visibilidad = :visibilidad "
				+ "and contacto.unidad.codigo = :codigo "
				+ "and contacto.tipoContacto.estado.codigoEstadoEntidad = :estat2"
				);
		Query queryContactosQuery = em.createQuery(queryContactos.toString());
		queryContactosQuery.setParameter("estat1", Dir3caibConstantes.ESTADO_ENTIDAD_VIGENTE);
		queryContactosQuery.setParameter("estat2", Dir3caibConstantes.ESTADO_ENTIDAD_VIGENTE);
		queryContactosQuery.setParameter("visibilidad", true);
		
		/*
		StringBuilder queryOficinas = new StringBuilder(
				"Select oficina "
				+ "from Oficina as oficina "
				+ "where oficina.codUoResponsable.codigo =:codigo "
				+ "and oficina.estado.codigoEstadoEntidad=:vigente "
				+ "order by oficina.codigo");
		
		Query queryOficinasQuery = em.createQuery(queryOficinas.toString());
		queryOficinasQuery.setParameter("vigente", Dir3caibConstantes.ESTADO_ENTIDAD_VIGENTE);
		*/
		for (UnidadExportar item : resultados) {
			
			// Contactos
			queryContactosQuery.setParameter("codigo", item.getCodigo()+Dir3caibConstantes.SEPARADOR_CODIGO_VERSION+item.getVersion());
			item.setContactos(transformarAUnidadExportarContactos(queryContactosQuery.getResultList()));
			
			// Oficinas
			// queryOficinasQuery.setParameter("codigo", item.getCodigo()+Dir3caibConstantes.SEPARADOR_CODIGO_VERSION+item.getVersion());
			// item.setOficinas(transformarAUnidadExportarOficinas(queryOficinasQuery.getResultList()));
		}
	...
	@Override
	@SuppressWarnings(value = "unchecked")
	public List<UnidadRestSistra> busquedaOrganismosSistra(String codigo, String denominacion,
			Long codigoNivelAdministracion, Long nivelJerarquico, Long codComunidad, boolean unidadRaiz, Long provincia,
			boolean vigentes) throws Exception {
	...
	private List<UnidadExportar> transformarAUnidadExportar(List<Object[]> resultados) {

		/*
		 
		0  => unidad.codigo
		1  => unidad.denominacion
		2  => unidad.estado.codigoEstadoEntidad
		3  => unidad.codUnidadRaiz.codigo
		4  => unidad.codUnidadRaiz.denominacion, 
		5  => unidad.codUnidadSuperior.codigo
		6  => unidad.codUnidadSuperior.denominacion
		7  => unidad.codLocalidad.descripcionLocalidad
		8  => unidad.esEdp
		9  => unidad.nivelJerarquico
		10 => unidad.nifcif
		11 => unidad.nivelAdministracion.descripcionNivelAdministracion
		12 => unidad.codTipoUnidad.descripcionTipoUnidadOrganica
		13 => unidad.tipoVia.descripcionTipoVia
		14 => unidad.nombreVia
		15 => unidad.numVia
		16 => unidad.complemento
		17 => unidad.codPostal
		18 => unidad.codAmbitoTerritorial.descripcionAmbito
		19 => unidad.codAmbPais.descripcionPais
		20 => unidad.codAmbComunidad.descripcionComunidad
		21 => unidad.codAmbProvincia.descripcionProvincia
		22 => unidad.codAmbIsla.descripcionIsla
		23 => unidad.denomLenguaCooficial
		24 => unidad.codUnidadRaiz.denomLenguaCooficial
		25 => unidad.codUnidadSuperior.denomLenguaCooficial
		26 => unidad.codigoDir3
		27 => unidad.codUnidadRaiz.codigoDir3
		28 => unidad.codUnidadSuperior.codigoDir3
		29 => unidad.version
		30 => unidad.nivelAdministracion.codigoNivelAdministracion
		31 => unidad.codAmbitoTerritorial.codigoAmbito
		32 => unidad.codAmbPais.codigoPais
		33 => unidad.codAmbProvincia.codigoProvincia
		34 => unidad.tipoVia.codigoTipoVia
		35 => unidad.estado.descripcionEstadoEntidad
		36 => unidad.codLocalidad.descripcionLocalidad
		37 => unidad.codAmbComunidad.codigoComunidad
		 
		 */

		List<UnidadExportar> listado = new ArrayList<UnidadExportar>();
		for (Object[] obj : resultados) {
			
			String denomCooficial = (String) obj[23]; 
			denomCooficial = (denomCooficial != null && denomCooficial.length() > 0) ? denomCooficial : (String) obj[1];			
			UnidadExportar temp = new UnidadExportar((String) obj[26], String.valueOf((Long)obj[29]), (String) obj[1], denomCooficial,
					(String) obj[35], String.valueOf((Boolean)obj[8]), (String) obj[10], String.valueOf((Long) obj[9]), (String) obj[11], (String) obj[12]);
			
			temp.setUnidadRaiz(new UnidadExportarDatosUnidad((String) obj[27], (String) obj[4], (String) obj[24]));
			temp.setUnidadSuperior(new UnidadExportarDatosUnidad((String) obj[28], (String) obj[6], (String) obj[25]));
			temp.setDireccion(new UnidadExportarDireccion((String) obj[7], (String) obj[13], (String) obj[14], (String) obj[15], (String) obj[16], (String) obj[17], 
					(String) obj[19], (String) obj[21], (String) obj[22], (String) obj[20], (String) obj[18]));
			temp.setContactos(new ArrayList<UnidadExportarContacto>());
			//temp.setOficinas(new ArrayList<UnidadExportarOficina>());
			listado.add(temp);
		}
		return listado;
	}
	
	private List<UnidadExportarOficina> transformarAUnidadExportarOficinas(List<Object[]> resultados) {
		
		/*
		 *
		 */
		
		List<UnidadExportarOficina> listado = new ArrayList<UnidadExportarOficina>();
		// for (Object[] obj : resultados) {}
			//listado.add();
	...
	private List<UnidadExportarContacto> transformarAUnidadExportarContactos(List<Object[]> resultados) {
		
		/*
		 * 0 => codigoTipoContacto
		 * 1 => valorContacto
		 */
		List<UnidadExportarContacto> listado = new ArrayList<UnidadExportarContacto>();
		for (Object[] obj : resultados) 
			listado.add(new UnidadExportarContacto((String) obj[1], (String) obj[0]));
