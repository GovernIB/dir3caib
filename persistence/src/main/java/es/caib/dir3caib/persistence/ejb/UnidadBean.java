...
public class UnidadBean extends BaseEjbJPA<Unidad, String> implements UnidadLocal {
    ...
    public Unidad findConHistoricosVigente(String codigo) throws Exception {
        ...
        Query q = em.createQuery("select unidad from Unidad as unidad where unidad.codigoDir3=:codigo and unidad.estado.codigoEstadoEntidad=:vigente");
    ...
    /**
     * Función que busca la unidad con id indicado y estado indicado
     *
     * @param id
     * @param estado
     * @return
    ...
    public Nodo findUnidad(String id, String estado, boolean denominacionCooficial) throws Exception {
        ...
        if (!unidades.isEmpty()) {
            ...
            String denominacionUnidadRaiz = (denominacionCooficial && Utils.isNotEmpty((String) obj[8])) ? (String) obj[8] : (String) obj[4];
            String denominacionUnidadSuperior = (denominacionCooficial && Utils.isNotEmpty((String) obj[9])) ? (String) obj[9] : (String) obj[6];
    ...
    public Unidad findByCodigoLigero(String codigo, boolean denominacionCooficial) throws Exception {
        ...
        if (result.size() == 1) {
            ...
            unidad.setDenominacion((denominacionCooficial && Utils.isNotEmpty((String) result.get(0)[6])) ? (String) result.get(0)[6] : (String) result.get(0)[1]);
    ...
    /**
     * Función que obtiene los hijos de primer nivel de una unidad en función del
    ...
    /**
     * Función que obtiene los codigos de los hijos vigentes de primer nivel de una
     * unidad
     *
     * @param codigo identificador de la unidad padre.
    ...
    /**
     * Función recursivo que obtiene los hijos de las unidades indicadas en función
    ...
    /**
     * Función recursivo que devuelve el árbol de unidades de la unidad indicada por
    ...
    /**
     * Función que devuelve el árbol de unidades de la unidad indicada por codigo,
    ...
    /**
     * Función que devuelve la unidad indicada por código siempre que esté vigente y
