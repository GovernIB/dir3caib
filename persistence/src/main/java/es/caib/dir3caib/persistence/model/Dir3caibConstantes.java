...
public class Dir3caibConstantes {
    ...
    public static final String CAT_TIPO_SERVICIO = "CAT_TIPO_SERVICIOS.CSV";
    public static final String CAT_TIPO_SERVICIOS_UO = "CAT_SERVICIOS_UO.CSV";
    public static final String CAT_TIPO_PODER = "CAT_PODER.CSV";
    public static final String CAT_TIPO_UNIDAD_NO_ORGANICA = "CAT_TIPO_UNIDAD_NO_ORGANICA.CSV";
    public static final String CAT_TIPO_CODIGO_FUENTE = "CAT_TIPO_CODIGO_FUENTE_EXT.CSV";
