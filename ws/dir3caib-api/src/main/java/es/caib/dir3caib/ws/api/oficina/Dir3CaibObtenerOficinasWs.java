...
public interface Dir3CaibObtenerOficinasWs {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "obtenerOficinasSIRUnidadV2", targetNamespace = "http://oficina.ws.dir3caib.caib.es/", className = "es.caib.dir3caib.ws.api.oficina.ObtenerOficinasSIRUnidadV2")
    @WebMethod
    @ResponseWrapper(localName = "obtenerOficinasSIRUnidadV2Response", targetNamespace = "http://oficina.ws.dir3caib.caib.es/", className = "es.caib.dir3caib.ws.api.oficina.ObtenerOficinasSIRUnidadV2Response")
    public java.util.List<es.caib.dir3caib.ws.api.oficina.OficinaWs> obtenerOficinasSIRUnidadV2(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.String arg0
    );
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "obtenerArbolOficinasV2", targetNamespace = "http://oficina.ws.dir3caib.caib.es/", className = "es.caib.dir3caib.ws.api.oficina.ObtenerArbolOficinasV2")
    @WebMethod
    @ResponseWrapper(localName = "obtenerArbolOficinasV2Response", targetNamespace = "http://oficina.ws.dir3caib.caib.es/", className = "es.caib.dir3caib.ws.api.oficina.ObtenerArbolOficinasV2Response")
    public java.util.List<es.caib.dir3caib.ws.api.oficina.OficinaWs> obtenerArbolOficinasV2(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.String arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        java.sql.Timestamp arg1,
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "obtenerOficinaV2", targetNamespace = "http://oficina.ws.dir3caib.caib.es/", className = "es.caib.dir3caib.ws.api.oficina.ObtenerOficinaV2")
    @WebMethod
    @ResponseWrapper(localName = "obtenerOficinaV2Response", targetNamespace = "http://oficina.ws.dir3caib.caib.es/", className = "es.caib.dir3caib.ws.api.oficina.ObtenerOficinaV2Response")
    public es.caib.dir3caib.ws.api.oficina.OficinaWs obtenerOficinaV2(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.String arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        java.sql.Timestamp arg1,
