...
/**
 * <p>Clase Java para buscarUnidadResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="buscarUnidadResponse">
 *   &lt;complexContent>
...
@XmlType(name = "buscarUnidadResponse", propOrder = {
    "_return"
})
public class BuscarUnidadResponse {
