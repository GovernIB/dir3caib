...
public class Dir3CaibObtenerCatalogosWsService extends Service {
    ...
    public Dir3CaibObtenerCatalogosWsService(WebServiceFeature ... features) {
    ...
    //API jar or re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1
    //compliant code instead.
    public Dir3CaibObtenerCatalogosWsService(URL wsdlLocation, WebServiceFeature ... features) {
    ...
    //API jar or re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1
    //compliant code instead.
    public Dir3CaibObtenerCatalogosWsService(URL wsdlLocation, QName serviceName, WebServiceFeature ... features) {
