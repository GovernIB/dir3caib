...
public interface Dir3CaibObtenerUnidadesWs {
    ...
    es.caib.dir3caib.ws.api.unidad.UnidadTF obtenerUnidad(
    ...
    java.util.List<es.caib.dir3caib.ws.api.unidad.UnidadTF> obtenerArbolUnidades(
            @WebParam(name = "arg0", targetNamespace = "")
                    java.lang.String arg0,
            @WebParam(name = "arg1", targetNamespace = "")
                    java.sql.Timestamp arg1,
    ...
    java.util.List<es.caib.dir3caib.ws.api.unidad.UnidadTF> obtenerArbolUnidadesDestinatarias(
            @WebParam(name = "arg0", targetNamespace = "")
                    java.lang.String arg0
    );
}
