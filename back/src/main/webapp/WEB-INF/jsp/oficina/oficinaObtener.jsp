                ...
                <div class="row-fluid">
                    ...
                    <div class="box span12">
                        ...
                        <div class="box-header well">
                            <h2><fmt:message key="oficina.obtener"/></h2>
                        </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <form:input id="fechaInicio" path="fechaInicio" maxlength="10" cssClass="input-xlarge datepicker" type="text" placeholder="dd/MM/yyyy"/> <form:errors path="fechaInicio" cssClass="help-inline" element="span"/>
