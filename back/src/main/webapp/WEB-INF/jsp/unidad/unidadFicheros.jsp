                                ...
                                <div class="form-horizontal">
                                  <div class="form-actions">
                                   <%-- <c:if test="${not empty mostrarimportacion}">--%>
                                      <input type="button" value="<fmt:message key="dir3caib.boton.importar"/>" onclick="javascript:confirm('<c:url value="/unidad/importar"/>','<fmt:message key="dir3caib.confirm.importar"/>');" class="btn btn-primary">
                                    <%--</c:if>
