...
<div class="box span9 minAlt">
        ...
        <div class="box llegenda">
            ...
            <div class="box-content">
                ...
                <c:if test="${not empty relacionesSirOfi}">
                    <div class="pad-bottom5">
											<span class="badge-arbre btn-ofsir llegendaCapsa">
												<i class="fa fa-exchange"></i> <spring:message code="oficina.oficina"/> <img src="<c:url value="/img/logo-SIR.png"/>" width="20" alt="SIR" title="SIR"/>
											</span>
                    </div>
                </c:if>
                ...
                <c:if test="${not empty relacionesOrganizativaOfi}">
                    <div class="pad-bottom5">
                        <span class="badge-arbre btn-success llegendaCapsa"><i class="fa fa-institution"></i> <spring:message code="dir3caib.oficina.organizativa"/></span>
                    </div>
                </c:if>
            </div>
        </div>
    ...
    <div class="btn-group infoBranca opcionArbol">
        <c:if test="${param.tipo == Dir3caibConstantes.UNIDAD}">
            <button type="button" class="btn btn-info infoBranca tamany12" onclick="goTo('<c:url value="/unidad/${unidad.codigo}/${paginaUrl}"/>')"><i class="fa fa-sitemap"></i> <spring:message code="dir3caib.arbol.abre"/></button>
        </c:if>
        <c:if test="${param.tipo == Dir3caibConstantes.OFICINA}">
            <button type="button" class="btn btn-info infoBranca tamany12" onclick="goTo('<c:url value="/oficina/${oficina.codigo}/${paginaUrl}"/>')"><i class="fa fa-sitemap"></i> <spring:message code="dir3caib.arbol.abre"/></button>
        </c:if>
    </div>
    ...
    <div class="tree">
        <ul>
            <li>
                <span class="panel-heading btn-danger vuitanta-percent" id="entidad" onclick="copyToClipboard(this)" style="cursor:copy">
                    <i class=""></i> ${unidadRaiz.codigo} - ${unidadRaiz.denominacion}</span>
                <ul>

                    <c:set var="contadorPrimer" value="0"/>
                    <c:set var="contadorSegon" value="0"/>
                    <c:set var="contadorTercer" value="0"/>
                    <c:set var="contadorQuart" value="0"/>
                    <c:set var="contadorCinque" value="0"/>
                    <c:set var="contadorSise" value="0"/>

                    <c:forEach var="organismo1" items="${unidadesPrimerNivel}">
                        <li>
                            <c:if test="${organismo1.esEdp == false}">
                                <span class="panel-heading btn-primary vuitanta-percent" id="zeroNivell" style="cursor:copy" onclick="copyToClipboard(this)">
                                    <i class=""></i> ${organismo1.codigo} - ${organismo1.denominacion}
                                </span>
                            </c:if>
                            <c:if test="${organismo1.esEdp == true}">
                                <span class="panel-heading btn-edp vuitanta-percent" id="zeroNivell" style="cursor:copy" onclick="copyToClipboard(this)">
                                    <i class=""></i> ${organismo1.codigo} - ${organismo1.denominacion}
                                </span>
                            </c:if>
                                ...
                                <c:forEach var="organismo2" items="${unidadesSegundoNivel}">
                                    <c:if test="${organismo2.codUnidadSuperior.codigo == organismo1.codigo}">
                                        <li>
                                            ...
                                            <c:set var="contadorPrimer" value="${contadorPrimer+1}"/>
                                            <ul>
                                                <!-- **** Oficinas ***-->
                                                <c:forEach var="oficinaPrincipal" items="${oficinasPrincipales}">
                                                ...
                                                <c:forEach var="organismo3" items="${unidadesTercerNivel}">
                                                    <c:if test="${organismo3.codUnidadSuperior.codigo == organismo2.codigo}">
                                                        <li>
                                                            ...
                                                            <c:set var="contadorSegon" value="${contadorSegon+1}"/>
                                                            <ul>
                                                                <!-- **** Oficinas ***-->
                                                                <c:forEach var="oficinaPrincipal" items="${oficinasPrincipales}">
                                                                    ...
                                                                    <c:if test="${organismo4.codUnidadSuperior.codigo == organismo3.codigo}">
                                                                        <li>
                                                                            ...
                                                                            <c:if test="${organismo4.esEdp == false}">
                                                                                <span class="panel-heading btn-primary vuitanta-percent" id="tercerNivell${contadorTercer}"
                                                                                      style="cursor:copy" onclick="copyToClipboard(this)"><i
                                                                                        class=""></i> ${organismo4.codigo} - ${organismo4.denominacion}
                                                                                </span>
                                                                            </c:if>
                                                                            <c:if test="${organismo4.esEdp == true}">
                                                                                <span class="panel-heading btn-edp vuitanta-percent" id="tercerNivell${contadorTercer}"
                                                                                      style="cursor:copy" onclick="copyToClipboard(this)"><i
                                                                                        class=""></i> ${organismo4.codigo} - ${organismo4.denominacion}
                                                                                </span>
                                                                            </c:if>

                                                                            <c:set var="contadorTercer" value="${contadorTercer+1}"/>
                                                                            <ul>
                                                                                <!-- **** Oficinas ***-->
                                                                                <c:forEach var="oficinaPrincipal" items="${oficinasPrincipales}">
                                                                                    ...
                                                                                    <c:if test="${organismo5.codUnidadSuperior.codigo == organismo4.codigo}">
                                                                                        <li>
                                                                                            ...
                                                                                            <c:if test="${organismo5.esEdp == false}">
                                                                                                <span class="panel-heading btn-primary vuitanta-percent"
                                                                                                      id="quartNivell${contadorQuart}" style="cursor:copy" onclick="copyToClipboard(this)"><i
                                                                                            ...
                                                                                            <c:set var="contadorQuart" value="${contadorQuart+1}"/>
                                                                                            <ul>
                                                                                                <!-- **** Oficinas ***-->
                                                                                                <c:forEach var="oficinaPrincipal" items="${oficinasPrincipales}">
                                                                                                ...
                                                                                                <c:forEach var="organismo6" items="${unidadesSextoNivel}">
                                                                                                    <c:if test="${organismo6.codUnidadSuperior.codigo == organismo5.codigo}">
                                                                                                        <li>
                                                                                                            ...
                                                                                                            <c:set var="contadorCinque" value="${contadorCinque+1}"/>
                                                                                                            <ul>
                                                                                                                <!-- **** Oficinas ***-->
                                                                                                                <c:forEach var="oficinaPrincipal" items="${oficinasPrincipales}">
                                                                                                                ...
                                                                                                                <c:forEach var="organismo7" items="${unidadesSeptimoNivel}">
                                                                                                                    <c:if test="${organismo7.codUnidadSuperior.codigo == organismo6.codigo}">
                                                                                                                        <li>
                                                                                                                            ...
                                                                                                                            <c:set var="contadorSise" value="${contadorSise+1}"/>
                                                                                                                            <ul>
