...
<div class="container row-fluid">
    <div class="pull-left dir3caib-footer">DIR3CAIB - &copy; <fmt:message key="dir3caib.titulo"/> - <fmt:message key="dir3caib.version"/> <%=Versio.VERSIO + (Configuracio.isCAIB()?"-caib": "")+ " " + (Configuracio.showTimeStamp()?"2015-09-10 8:31" : "")%></div>
