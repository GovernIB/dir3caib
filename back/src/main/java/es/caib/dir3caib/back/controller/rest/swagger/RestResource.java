...
public class RestResource {
	...
	@Operation(operationId = "existeOficina", summary = "Servei per a esbrinar si una oficina existeix i està activa a partir del seu codi Dir3")
	@APIResponses(value = {
			@APIResponse(responseCode = "200", description = "Booleà indicant l'existència de l'oficina", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = Boolean.class))) })
	...
	@Operation(operationId = "existeUnidad", summary = "Servei per a esbrinar si una unitat existeix i està activa a partir del seu codi Dir3")
	@APIResponses(value = {
			@APIResponse(responseCode = "200", description = "Booleà indicant l'existència de la unitat", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = Boolean.class))) })

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/unidad/existe")
	public Response existeUnidad(

			@Parameter(description = "codi de la unitat que cercam", required = true, example = "A04059084", schema = @Schema(implementation = String.class)) @QueryParam("codigo") String codigo
